...
console.log('The ISBN of the first book in the array "bookshelf" is:', bookshelf[0].isbn);
console.log('The title of the third book in the array "bookshelf" is:', bookshelf[2].title);
